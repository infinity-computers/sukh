    ...
    <div class="max-w-5xl mx-auto px-4 py-6 sm:py-8">
        ...
        <form method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-xl p-5 sm:p-8 space-y-8">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button type="submit" id="submitBtn" disabled class="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition w-full sm:w-auto opacity-50 cursor-not-allowed">Create Property</button>
