...
<div class="max-w-5xl mx-auto px-4 py-6 sm:py-8">
    ...
    <form method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-xl p-5 sm:p-8 space-y-8">
        ...
        <section id="rentFields" class="space-y-4 <?php echo (($property['property_type'] ?? 'sell') === 'rent') ? '' : 'hidden'; ?>">
        ...
        <section id="commercialFields" class="space-y-4 <?php echo in_array($property['category'] ?? 'Apartment', ['Commercial Shop', 'Office', 'Warehouse'], true) ? '' : 'hidden'; ?>">
...
function updateConditionalSections() {
    ...
    const isCommercial = category && ['Commercial Shop', 'Office', 'Warehouse'].includes(category.value);
